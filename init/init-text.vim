function GPLV2()
    call setline(1,"/**-------------------------------------------------------------------------")
    call append (2, " * ")
    call append (3, " * Copyright (C) 2020 KunMing Xie <kunming.xie@hotmail.com>")
    call append (4, " * ")
...
function Apache()
    call setline(1,"/* Copyright 2020 kunming.xie")
    call append (1, " *")
...
function AddAstute()
    ...
    call append( 4, "\/\/  Copyright (C) 2020 Nanjing Astute Software Technology Co., Ltd. All rights reserved.")
    call append( 5, "\/\/")
    call append( 6, "")
endf
